        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Detail Order Care</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card col-md-8 offset-md-2">
              ...
              <div class="col-md-2 offset-md-5 mb-2">
                <button type="button" name="search" id="search_care" class="btn btn-info form-control"><span class="fa fa-filter"></span></button>
              </div>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered text-center" id="example" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php foreach($care_data as $d_care):?>
                    <tr>
                      <td><?php echo $d_care->id_order;?></td>
                      <td><?php echo $d_care->nama_penerima;?></td>
                      <td><?php echo $d_care->nama_paket;?></td>
                      <td><?php echo exDate($d_care->tgl_order);?></td>
                      <td><?php echo 'Rp. '. rpCurrency($d_care->total);?></td>
                      <td><?php echo '<img class="someClass" src="'.base_url().'assets/img/bukti_transfer/'.$d_care->bukti_transfer.'" alt="'.$d_care->bukti_transfer.'" style="width:84px; height:59px;">'?></td>
                      <td><?php echo $d_care->no_telp;?></td>
                      <td><?php echo $d_care->alamat;?></td>
                    </tr>
                    <?php endforeach;?>
                  </tbody>
                </table>
