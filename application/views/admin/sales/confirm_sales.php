              ...
              <div class="table-responsive">
                <table class="table table-bordered text-center" id="example" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo $d_confirm->id_pesanan;?></td>
                      <td><?php echo $d_confirm->nama_penerima;?></td>
                      <td><?php echo exDate($d_confirm->tgl_pemesanan);?></td>
                      ...
                      <td>
                        <a href=<?php echo 'confirm/'.$d_confirm->id_pesanan?> class="btn btn-primary" onclick="return confirm('Apakah anda yakin akan menyetujui pesanan ini?')"><span class="fas fa-fw fa-check fa-sm"></span></a>
                        <a href=<?php echo 'tolak/'.$d_confirm->id_pesanan?> class="btn btn-danger" onclick="return confirm('Apakah anda yakin akan menolak pesanan ini?')"><span class="fas fa-fw fa-times fa-sm"></span></a>
                      </td>
                    </tr>
                    <?php endforeach;?>
                  </tbody>
