      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-8 ftco-animate">
						<form action="<?php echo base_url('order') ?>" method="post" class="billing-form bg-light p-3 p-md-5">
	          ...
	          <div class="row mt-5 pt-3 d-flex">
	          	<div class="col-md-6 d-flex">
	          		<div class="cart-detail cart-total bg-light p-3 p-md-4">
	          			...
	          			<p class="d-flex">
		    						<span>Subtotal</span>
		    						<span><?php $grandTotal =$this->cart->total();  echo 'Rp. '.rpCurrency($grandTotal);?></span>
		    					</p>
		    					<p class="d-flex">
		    						<span>Delivery</span>
