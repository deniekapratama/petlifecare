...
<section class="ftco-section bg-light ftco-services">
  ...
  <div class="form-group" style="margin-left:200px; margin-right:200px; min-width:50%;">
    ...
    <input type="text" class="form-control" name="tipe_pet" id="tipe_pet" value="Cat" readonly>
  </div>
  ...
  <div class="form-group" style="margin-left:200px; margin-right:200px; min-width:50%;">
    ...
    <p style="color: #a71304; font-size: 12px; margin-bottom: 0px;">Rp. 20.000/days (Including Food)</p>
    <p style="color: #a71304; font-size: 12px;">Rp. 15.000/days (Excluding Food)</p>
  </div>
