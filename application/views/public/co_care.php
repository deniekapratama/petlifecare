        ...
        <div class="row justify-content-center">
          <div class="col-xl-8 ftco-animate">
	          ...
	          <div class="row mt-5 pt-3 d-flex">
	          		...
	          		<div class="cart-detail cart-total bg-light p-3 p-md-4">
	          			...
	          			<p class="d-flex">
		    						...
		    						<?php if($this->uri->segment(2) == 'fresh'){?>
		    							<span><?php $biaya=50000; echo 'Rp. '.rpCurrency($biaya);?></span>
		    						<?php }elseif($this->uri->segment(2) == 'happy'){?>
		    							<span><?php $biaya=70000; echo 'Rp. '.rpCurrency($biaya);?></span>
		    						<?php }else{?>
		    							<span><?php $biaya=120000; echo 'Rp. '.rpCurrency($biaya);?></span>
		    						<?php }?>
		    					</p>
		    					<p class="d-flex">
		    						<span>Fare</span>
	          	...
	          	<input type="hidden" name="paket" value="<?php echo 'cat_'.$this->uri->segment(2);?>">
