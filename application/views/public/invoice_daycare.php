			...
			<div class="container">
    			...
    			<div class="col-md-12 ftco-animate fadeInUp ftco-animated">
	    				<table class="table-responsive">
	    					...
	    					<tr class="text-center">
	    						<td colspan="" style="padding: 12px!important;">Order Type</td>
	    						<td></td>
	    						<td style="font-size: 20px; text-align: right!important; width: 81%; padding: 12px!important;">
	    							<?php echo $d_invoice->tipe_pet;?>		
	    						</td>
	    					</tr>
	    					<tr class="text-center">
...
<!-- ============ MODAL ADD BARANG =============== -->
        <div class="modal fade" id="modal_confirm" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" action="<?php echo base_url('process_invoice_daycare') ?>" method="post" enctype="multipart/form-data">
