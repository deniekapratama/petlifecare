      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-8 ftco-animate">
						<form action="<?php echo base_url('order_daycare') ?>" method="post" class="billing-form bg-light p-3 p-md-5">
	          ...
	          <div class="row mt-5 pt-3 d-flex">
	          	<div class="col-md-6 d-flex">
	          		<div class="cart-detail cart-total bg-light p-3 p-md-4">
	          			...
	          			<p class="d-flex">
		    						<span>Subtotal</span>
		    						<span><?php $biaya=$total_biaya; echo 'Rp. '.rpCurrency($biaya);?></span>
		    					</p>
		    					<p class="d-flex">
		    						<span>Fare</span>
	          	...
	          	<input type="hidden" name="tipe_pet" value="<?php echo $tipe_pet;?>">
	          	<input type="hidden" name="lama_penitipan" value="<?php echo $lama_penitipan;?>">
	          	<input type="hidden" name="id_user" value="<?php echo $this->session->userdata('id_user');?>">
	          	<input type="hidden" name="nama" value="<?php echo $nama_penerima;?>">
